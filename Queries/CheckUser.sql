USE accommodations
select * from systemuseraccounts where userName like 'BAHOLTEST2XML' and userPassword like '%THOM%'
...
select * from SystemUsers where SystemUserCompanyID='1444' or SystemUserCompanyID='10939'
